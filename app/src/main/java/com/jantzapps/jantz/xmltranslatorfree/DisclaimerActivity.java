    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch(item.getItemId()) {
            case R.id.action_home:
                ...
                DisclaimerActivity.this.startActivity(homeIntent);
                finish();
                return true;
            case R.id.action_help:
                Intent helpIntent = new Intent(DisclaimerActivity.this, InstructionActivity.class);
                DisclaimerActivity.this.startActivity(helpIntent);
                finish();
                return true;
